...
//        Если в num1 и num2 будет null (пользователь отправил пустую форму) или буквы, то получим 500-ю.
//        Поэтому по-хорошему нужно добавлять валидацию данных в фильтре или самом сервлете и в случае их невалидности
//        отправлять клиенту 400-ю (например, сделать под ошибку отдельный jsp-шаблон)
